...
If I just do what the matrix operators do directly on the statevector then I can save on compute and stuff

"""


class StatevectorSimulator_V2:
    """A statevector simulator for an n-qubit quantum system."""
    ...
    def x(self, qubit: int) -> None:
        ...
        mask=1<<qubit
        st_0= (self.index & mask)==0
        st_1= (self.index & mask)==1
